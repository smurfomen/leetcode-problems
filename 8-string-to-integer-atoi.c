...
public:
    int myAtoi(string s) {
        ...
        while(i < s.size())
        {
            ...
            if(sign == -1 && -1 * result < numeric_limits<int>::min())
                return numeric_limits<int>::min();
            else if(sign == 1 && result > numeric_limits<int>::max())
...
int main(int argc, char * argv[]) {
    ...
    assert(sol.myAtoi("20000000000000000000") == 2147483647);
    assert(sol.myAtoi("  -0k4") == 0);
